...
| 3 | Workflow Engine (skeleton) | workflow_definitions, workflow_steps, workflow_instances, workflow_approval_actions | 🟢 kode+DB merge main 2026-09-13 (PR #1), sisa: acceptance demo/review |
| 4 | Inventory & Stock | stock_balances, stock_movements(+6), stock_transfers, stock_opnames, serial_numbers, batch_lots | ✅ hijau 2026-09-13 (0008 tabel + 0009 partisi/RLS + lib + API 11 endpoint + test 15 baru; 70/70 hijau) |
